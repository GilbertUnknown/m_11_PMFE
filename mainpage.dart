...
import 'package:m_11/todospage.dart';
import 'package:provider/provider.dart';
import 'package:m_11/darktheme.dart';
// import 'package:m10/todospage.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        ...
        Text(
          'Unfinished',style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 25),
        ...
        Divider(
         ...
         Text(
          'Finished',style: TextStyle(color:Colors.green,fontWeight: FontWeight.bold,fontSize: 25),
          textAlign: TextAlign.left,
        ),
        Divider(
          color: Colors.black,
